...
int write_binary_su3_vector_data(su3_vector * const s, 
		...
		const int prec, const int t0) {
	int x, X, y, Y, z, Z, t, tag=0, id=0, i=0, status=0;
	int latticeSize[] = {1, g_nproc_x*LX, g_nproc_y*LY, g_nproc_z*LZ};
	su3_vector tmp[1];
	float tmp2[24];
	int coords[4];
